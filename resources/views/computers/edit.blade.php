          ...
          <div class="max-w-4xl mx-auto mt-20">
               <form action="{{ route('computers.update', $computer->id) }}" method="POST">
                    ...
                    <div class="py-4">
                         ...
                         <input type="text" value="{{ $computer->name }}" name="computer-name" id="computer-name" placeholder=" " class="block w-full px-5 py-3 text-base text-white rounded-md appearance-none bg-zinc-900 focus:outline-none ">
                         @error('computer-name')
                    ...
                    <div class="py-4">
                         ...
                         <input type="text" value="{{ $computer->country }}" name="computer-country" id="computer-country" placeholder=" " class="block w-full px-5 py-3 text-base text-white rounded-md appearance-none bg-zinc-900 focus:outline-none ">
                    ...
                    <div class="py-4">
                         ...
                         <input type="text" value="{{ $computer->price }}" name="computer-price" id="computer-price" placeholder=" " class="block w-full px-5 py-3 text-base text-white rounded-md appearance-none bg-zinc-900 focus:outline-none ">
